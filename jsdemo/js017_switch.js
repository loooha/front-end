...
/*
[switch문]
선택문인 switch문은 변수에 저장된 값과 switch문에 있는 경우(case)의 값을 검사하여, 변수와 경우의 값에서 일치하는 값이 있을 때 그에 해당하는 실행문을 실행한다.
...
*/
//console.log(85 / 10); 값 8.5
//console.log(parseInt(85 / 10)); parseInt 정수값으로 변환해줌
...
/*
code='100'이면 '채소류', code='200'이면 '육류', code='300'이면 '생선류'라고 출력
*/
let code = "b200";
switch (code) {
  case "a100":
