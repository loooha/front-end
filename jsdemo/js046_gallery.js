//
//(1) 작은 이미지를 클릭하면 큰 이미지를 보이게
let bigPhoto = document.querySelector("#photo > img");
console.log(bigPhoto); //<img src="../images/pic_1.jpg" width="320" alt="" />
...
//
//(2) 다음(>) 버튼을 클릭할때 마다 <li>가 -100만큼 이동하게 한다.
let m_num = 0;
...
//
//(3) 이전(<) 버튼을 클릭할때 마다 <li>가 100만큼 이동한게 한다.
